...
**Closed 2026-09-25:** measured in `docs/testing/tests.md` (six full CI runs, both targets equal on time
...
- `@smoke` and `@e2e` on both targets, recording wall time, boot time, load and pass counts,
  in the table in `docs/testing/tests.md` next to the existing measurements.
...
- `docs/testing/tests.md`: both targets, what each is for, and the measured numbers.
