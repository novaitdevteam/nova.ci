...
<p align="center">
  <img src="assets/tests.svg" width="100%" alt="the advisory lint and unit-test gate in the build workflow, and the unit, integration and both modes of the test workflow" />
</p>
...
The Playwright suite from `novatalks.tests` has its own page: [End-to-end tests](e2e.md).
