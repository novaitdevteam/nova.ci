...
<p align="center">
  <img src="assets/routing.svg" width="100%" alt="the switcher matches on repository, event and action, ref type and name, and commit message, then fans out to the build workflow, the test workflows, and the web and mobile workflows" />
</p>
...
[← Quick start](../getting-started/quick-start.md) · [Docs index](../README.md) · [Build pipeline →](build-pipeline.md)
