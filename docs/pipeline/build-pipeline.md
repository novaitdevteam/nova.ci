...
<p align="center">
  <img src="assets/pipeline.gif" width="100%" alt="linter then unit-test run sequentially on every event including pull requests; build-image, trivy-scan and notify run only on push and tag events" />
</p>
